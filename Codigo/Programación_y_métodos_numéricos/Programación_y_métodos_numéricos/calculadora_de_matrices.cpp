...
int main(){
    int Opcion = 0;
    cout<<"Que operación deseas hacer: "<<endl<<"si ingresas el 1: Sumas/restas de matrices."<<endl<<"si ingresas el 2 producto escalar a una matriz."<<endl<<"si ingresas el 3 multiplicacion entre 2 matrices."<<endl<<"si ingresas el 4 generar una matriz de numeros primos: ";
    cin>>Opcion;
    cout<<endl;
    if(Opcion == 1){
        int m, n;
